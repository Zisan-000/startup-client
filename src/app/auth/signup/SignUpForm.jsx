...
export default function SignUpForm() {
  ...
  const handleSignup = async (e) => {
    ...
    // Better Auth standard signup configuration
    ...
    if (error) {
      toast.error(error.message || "Error signing up components");
    }
  };
    ...
    <Card className="w-full max-w-md p-8 bg-white dark:bg-zinc-800 rounded-2xl border border-zinc-200 dark:border-zinc-700/50 shadow-sm space-y-6">
      ...
      <Form onSubmit={handleSignup} className="flex flex-col gap-4">
        ...
        >
          ...
          <Input type="url" placeholder="https://example.com/profile.jpg" />
          <FieldError />
        </TextField>
